...
@app.on_message(filters.command("repjjjjjnnhgio"))
...
@app.on_message(filters.command("clonbnkhjjue"))
...
@app.on_message(filters.command("gadd") & filters.user(int(8150875959)))
